<template>
    ...
    <n-grid-item span='0:24 640:24 1024:12'>
      <n-card :bordered='false' class='rounded-16px shadow-sm'>
        ...
        <n-space v-if='modeChoosed == 1' justify='center'>
          <n-image src="../系统图/朗肯循环.jpeg" alt="mode-choice" width="600" />
					<n-image src="../系统图/朗肯循环T-S图.jpg" alt="mode-choice" width="600" />
        </n-space>
  ...
  <n-space vertical>
    ...
    <n-card :bordered='false' class='rounded-16px shadow-sm'>
      <n-space justify='center'>
        <p class='text-24px font-bold pb-12px'>朗肯循环仿真结果参数输出表</p>
...
function excelExport() {
  ...
  let name = Date().split(" ").slice(3, 5).join("_") + '_结果输出表.xlsx';
